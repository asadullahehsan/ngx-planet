    ...
    ngOnInit() {
        ...
        this.planet.registerApps([
            ...
            },
            {
                ...
                hostParent: '#app-host-container',
                hostClass: appHostClass,
                routerPathPrefix: '/projects/app4',
                selector: 'app4-root',
                resourcePathPrefix: '/static/app4/',
                preload: settings.app4.preload,
                switchMode: settings.app4.switchMode,
                sandbox: true,
                stylePrefix: 'app4',
                // prettier-ignore
                scripts: [
                ...
                styles: ['styles.css'],
                manifest: '/static/app4/assets-manifest.json',
                extra: {
                    name: '应用3',
                    color: '#66c060'
                }
